...
export default function EventsCarousel() {
  ...
  const handleManualNavigation = (newDirection: number) => {
    ...
    // Reanudar auto-rotación después de 8 segundos de inactividad
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-2 relative z-10">
                  ...
                  <div className="relative h-48 sm:h-64 md:h-80 lg:h-full min-h-[300px] overflow-hidden">
                    ...
                    {!currentEvent.isComingSoon && (
                      ...
                      >
                        <span className={`px-3 py-2 md:px-6 md:py-3 text-white rounded-full text-xs md:text-sm font-bold shadow-lg backdrop-blur-sm ${
                          currentEvent.isPastEvent 
                            ? 'bg-gradient-to-r from-gray-500 to-gray-600' 
                            : 'bg-gradient-to-r from-[var(--color-pink-vibrant)] to-[var(--color-lavender)]'
                        }`}>
                    ...
                    >
                      {currentEvent.isComingSoon ? (
                        ...
                        <div className="bg-gradient-to-r from-gray-500 to-gray-600 text-white rounded-full px-4 py-2 shadow-lg backdrop-blur-sm">
                          <span className="text-sm md:text-base font-bold">Evento Pasado</span>
                        </div>
                      ) : (
                  ...
                  <div className="p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-between min-h-[400px] lg:min-h-[500px]">
                    <div className="flex-1">
                      ...
                      >
                        {!currentEvent.isComingSoon ? (
                          <>
                            <div className={`flex items-center gap-2 backdrop-blur-sm px-3 py-2 rounded-full w-full sm:w-auto justify-center sm:justify-start border ${
                              currentEvent.isPastEvent 
                                ? 'bg-gradient-to-r from-gray-100 to-gray-200 border-gray-300' 
                                : 'bg-gradient-to-r from-[var(--color-pink-vibrant)]/10 to-[var(--color-lavender)]/10 border-[var(--color-pink-vibrant)]/20'
                            }`}>
                              <svg
                                className={`w-4 h-4 md:w-5 md:h-5 flex-shrink-0 ${
                                  currentEvent.isPastEvent ? 'text-gray-500' : 'text-[var(--color-pink-vibrant)]'
                                }`}
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                              ...
                              <span className={`text-sm md:text-base font-medium text-center sm:text-left ${
                                currentEvent.isPastEvent ? 'text-gray-600' : 'text-[var(--color-black-soft)]/80'
                              }`}>
                            ...
                            <div className={`flex items-center gap-2 backdrop-blur-sm px-3 py-2 rounded-full w-full sm:w-auto justify-center sm:justify-start border ${
                              currentEvent.isPastEvent 
                                ? 'bg-gradient-to-r from-gray-100 to-gray-200 border-gray-300' 
                                : 'bg-gradient-to-r from-[var(--color-lavender)]/10 to-[var(--color-pink-vibrant)]/10 border-[var(--color-lavender)]/20'
                            }`}>
                              <svg
                                className={`w-4 h-4 md:w-5 md:h-5 flex-shrink-0 ${
                                  currentEvent.isPastEvent ? 'text-gray-500' : 'text-[var(--color-lavender)]'
                                }`}
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                      ...
                      {currentEvent.promo && !currentEvent.isPastEvent && (
                        <motion.div
                        ...
                        >
                          <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-3 rounded-xl border border-green-200 text-center">
                            <div className="flex items-center justify-center gap-2 mb-1">
                              <svg className="w-5 h-5 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                              </svg>
                              <span className="text-sm font-bold text-green-800">¡Promoción Especial!</span>
                            </div>
                            <p className="text-lg font-bold text-green-900">{currentEvent.promo}</p>
                          </div>
                        </motion.div>
                      )}

                      {/* Horario especial para cursos */}
                      {currentEvent.schedule && !currentEvent.isPastEvent && (
                        <motion.div
                          className="mb-4 md:mb-6"
                          initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
                        ...
                        >
                          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-3 rounded-xl border border-blue-200 text-center">
                            <div className="flex items-center justify-center gap-2 mb-1">
                              <svg className="w-5 h-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                              </svg>
                              <span className="text-sm font-bold text-blue-800">Horario del Curso</span>
                            </div>
                            <p className="text-sm font-bold text-blue-900">{currentEvent.schedule}</p>
                          </div>
                        </motion.div>
                      )}
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-3 rounded-xl border border-green-200">
                                  <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span className="text-xs font-medium text-green-700">Horario de Entrada</span>
                                  </div>
                                ...
                                <div className="bg-gradient-to-r from-orange-50 to-red-50 p-3 rounded-xl border border-orange-200">
                                  <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span className="text-xs font-medium text-orange-700">Horario de Salida</span>
                                  </div>
                                  <p className="text-sm font-bold text-orange-800">{currentEvent.returnTime}</p>
                                  <p className="text-xs text-orange-600">Desde {currentEvent.departureLocation}</p>
                                </div>
                              </div>
                            </motion.div>
                            ...
                            >
                              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-200">
                                <div className="flex items-start gap-3">
                                  ...
                                  <div>
                                    <h4 className="font-bold text-blue-800 mb-1">Ubicación</h4>
                    ...
                    >
                      {currentEvent.isComingSoon ? (
                        ...
                        <div className="text-center">
                          ...
                          <h4 className="text-lg md:text-xl font-bold text-gray-700 mb-2">
                            Evento Realizado
                          </h4>
                          <p className="text-sm md:text-base text-gray-600 mb-4">
                            Este evento ya se llevó a cabo. ¡Mantente atento a nuestros próximos eventos!
                          </p>
